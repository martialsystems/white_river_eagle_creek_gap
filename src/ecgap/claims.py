...
"""Fail closed: gage lag, not inundation, not feet, not a closed reach."""
...
from ecgap.errors import ClaimBanError
...
_BANS: tuple[tuple[str, re.Pattern[str]], ...] = (
    ...
    ("feet_invert", re.compile(r"\binvert(?:ed|ing)? (?:Nora |Indy |Indianapolis |Centerton )?Q to feet\b", re.I)),
    ("nwm_repull", re.compile(r"\bre-pull(?:ed|ing)? NWM\b", re.I)),
    ("flood_ai", re.compile(r"\bflood AI\b", re.I)),
    ("little_as_eagle", re.compile(r"\b03353600 is Eagle Creek\b", re.I)),
    ("centerton_closed", re.compile(r"\bEagle Creek explains Centerton\b", re.I)),
)
